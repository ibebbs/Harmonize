...
namespace Bebbs.Harmonize.With.Owl.Intuition.State
{
    ...
    internal class Transition : ITransition
    {
        ...
        public Transition(Event.IMediator eventMediator, Event.IFactory eventFactory, Context.IFactory contextFactory)
        {
        ...
        public void ToDisconnected()
        {
            ...
            Event.TransitionState message = _eventFactory.ForStateTransition(context);
